package com.iteratrlearning.design_patterns.answers.optional;
...
public class RefactoringToOptional {
    ...
    @Test
    public void missingPropertyDoesntThrow() {
        assertEquals(0, readDurationWithOptional(properties, "xyzzy"));
    }
