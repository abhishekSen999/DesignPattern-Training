...
// TODO: refactor NetworkEncoder to make use of Strategy design pattern
@Ignore
public class NetworkEncoderTest {
    ...
    public void shouldEncodePlainWhenSlowAndBelowThreshold() {
        String input = "Hello";
        NetworkEncoder networkEncoder = new NetworkEncoder(Status.ENCODED, Encoding.ZIP, 10);
    ...
    public void shouldEncodeGZipWhenSlowAndAboveThreshold() {
        String input = "Hello World! How are you";
        NetworkEncoder networkEncoder = new NetworkEncoder(Status.ENCODED, Encoding.GZIP, 10);
    ...
    public void shouldEncodePlainWhenFastStatusAndAboveThreshold(){
        String input = "Hello";
        NetworkEncoder networkEncoder = new NetworkEncoder(Status.FAST, Encoding.ZIP, 30);
